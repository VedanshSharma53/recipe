...
const generateRecipe = async (req, res) => {
  try {
      const ingredients = req.query.ingredients || "pasta"; // Default to 'pasta' if no ingredients provided
      const apiKey = "4f7012bc95b84510a955a8d48626b23c"; // Replace with your Spoonacular API key
